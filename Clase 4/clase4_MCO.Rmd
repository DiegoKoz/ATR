...
ggplot(estados, aes(x=Murder,y=life_exp)) + geom_point(size=2) +
    geom_hline(yintercept = mean(states$life_exp), color='steelblue', linetype='dashed', size=1) +
    geom_vline(xintercept = mean(states$Murder), color='steelblue', linetype='dashed', size=1) +
...
ggplot(estados, aes(x=Murder,y=Illiteracy)) + geom_point(size=2) +
  geom_hline(yintercept = mean(states$Illiteracy),color='steelblue', linetype='dashed', size=1) +
  geom_vline(xintercept = mean(states$Murder), color='steelblue', linetype='dashed', size=1) +
...
ggplot(estados, aes(x=Area,y=Illiteracy)) + geom_point(size=2) +
  geom_hline(yintercept = mean(states$Illiteracy),color='steelblue', linetype='dashed', size=1) +
  geom_vline(xintercept = mean(states$Area), color='steelblue', linetype='dashed', size=1) +
...
Imagenes de spurious correlations

Ejemplo de `estados` con Frost vs Murder
