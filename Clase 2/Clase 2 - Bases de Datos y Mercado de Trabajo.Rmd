...
Una de las grandes utilidades de __R__ es la posibilidad de trabajar con múltiples bases de datos al mismo tiempo. Por ejemplo, podría resultarnos útil calcular las tasas básicas del mercado de trabajo para dos trimestres a la vez. A continuación veremos que con dos comandos sencillos podremos realizarlo. Para eso cargaremos a continuación en nuestro ambiente la base del 4° trimestre de 2016.
...
Union_Bases
```
Una vez que contamos con nuestra unión de las bases de 2 o más trimestres, simplemente debemos realizar nuestros cálculos agrupados por las variables __ANO4__ y __TRIMESTRE__ y podremos realizar estimaciones para sendos períodos al mismo tiempo
```{r}
